...
const ShippingAddress = ({ isActive, onCloseActive, onOpenActive }) => {
  return (
    <div className="rounded-xl border border-neutral-300 ">
      <div className="flex flex-col items-start p-6 sm:flex-row">
        ...
        <div className="flex w-full items-center justify-between">
          <div className="sm:ml-8">
            <span className="uppercase text-[15px]">SHIPPING ADDRESS</span>
      ...
      {/* ============ */}
      <div className="flex flex-col py-2 px-6 sm:flex-row">
        <ButtonPrimary className="shadow-none sm:!px-7 my-4" onClick={onCloseActive}>
